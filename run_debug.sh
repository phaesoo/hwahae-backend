...
# load initial data
python manage.py loaddata api/fixtures/item.json --settings=myapp.settings.local
python manage.py loaddata api/fixtures/ingredient.json --settings=myapp.settings.local
